...
#define WM_WINDOW_SIZE_FOR_PICTURE WM_USER+9520
#define WINDOW_START_METRICS 150
#define FILE_DATABASE_NAME _T("C:\\FileManager.xml")
#define CAPTION_DATABASE_NAME  _T("Caption_save.xml")
